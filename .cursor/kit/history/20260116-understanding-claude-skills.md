...
1. **从简单开始** - 先使用现有 Skills,理解其工作方式,逐步创建自定义 Skills
2. **遵循最佳实践** - 保持 SKILL.md 简洁,写清晰的 description,使用渐进式披露
3. **持续优化** - 收集使用反馈,迭代改进 Skills,分享经验教训

---

**文档版本**: 1.0.0  
**最后更新**: 2026年1月16日  
**作者**: Claude (基于 agentskills.io 和 agent-skills 项目研究)
